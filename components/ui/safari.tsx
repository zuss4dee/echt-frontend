...
export interface SafariProps extends HTMLAttributes<HTMLDivElement> {
  ...
  imageSrc?: string
  videoSrc?: string
  /** Optional URL to render inside an iframe as the page content */
  frameSrc?: string
  mode?: SafariMode
}
...
export function Safari({
  ...
  const hasMedia = hasVideo || !!imageSrc || hasFrame
